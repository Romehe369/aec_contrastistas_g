...
################################################################################
## Form generated from reading UI file 'menuDOEtZi.ui'
##
...
"}")
        ...
        self.label_4.setGeometry(QRect(340, 20, 161, 31))
        font2 = QFont()
...
" GENERALES", None))
        self.label.setText("")
        self.label_4.setText(QCoreApplication.translate("sistema", u"Registrar", None))
