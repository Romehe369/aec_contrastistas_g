...
################################################################################
## Form generated from reading UI file 'add_workerrkvsLR.ui'
##
...
"}")
        ...
        self.frame_tick = QFrame(self.centralwidget)
        self.frame_tick.setObjectName(u"frame_tick")
        self.frame_tick.setStyleSheet(u"")
        self.horLay_tick = QHBoxLayout(self.frame_tick)
        self.horLay_tick.setSpacing(0)
        self.horLay_tick.setObjectName(u"horLay_tick")
        self.horLay_tick.setContentsMargins(0, 0, 0, 0)
        self.horizontalSpacer_5 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horLay_tick.addItem(self.horizontalSpacer_5)

        self.btn_tick = QPushButton(self.frame_tick)
        self.btn_tick.setObjectName(u"btn_tick")
        self.btn_tick.setMinimumSize(QSize(31, 31))
        self.btn_tick.setMaximumSize(QSize(31, 31))
        self.btn_tick.setStyleSheet(u"QPushButton{\n"
...
"}")
        icon = QIcon()
        icon.addFile(u"./assets/tick.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_tick.setIcon(icon)
        self.btn_tick.setIconSize(QSize(30, 30))

        self.horLay_tick.addWidget(self.btn_tick)

        self.btn_untick = QPushButton(self.frame_tick)
        self.btn_untick.setObjectName(u"btn_untick")
        self.btn_untick.setMinimumSize(QSize(31, 31))
        self.btn_untick.setMaximumSize(QSize(31, 31))
        self.btn_untick.setStyleSheet(u"QPushButton{\n"
"background-color: rgba(0,0,0,0%);\n"
"}\n"
"QPushButton:hover{\n"
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"./assets/unchecked.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_untick.setIcon(icon1)
        self.btn_untick.setIconSize(QSize(30, 30))

        self.horLay_tick.addWidget(self.btn_untick)

        self.label = QLabel(self.frame_tick)
        self.label.setObjectName(u"label")
        self.label.setStyleSheet(u"font: 75 12pt \"MS Shell Dlg 2\";")

        self.horLay_tick.addWidget(self.label)

        self.horizontalSpacer_6 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horLay_tick.addItem(self.horizontalSpacer_6)


        self.gridLayout.addWidget(self.frame_tick, 4, 3, 1, 1)


        self.verticalLayout.addLayout(self.gridLayout)

        self.frame_dni = QFrame(self.centralwidget)
        self.frame_dni.setObjectName(u"frame_dni")
        self.horizontalLayout = QHBoxLayout(self.frame_dni)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(15, -1, 15, -1)
        self.verticalLayout_2 = QVBoxLayout()
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.label_sexo_2 = QLabel(self.frame_dni)
...
"background-color: qlineargradient(spread:pad, x1:0.409318, y1:0.636, x2:0.432, y2:0.0454545, stop:0 rgba(59, 123, 255, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.pushButton_cargar = QPushButton(self.frame_dni)
        ...
        self.pushButton_delete = QPushButton(self.frame_dni)
        ...
        self.label_sexo_3 = QLabel(self.frame_dni)
...
"background-color: qlineargradient(spread:pad, x1:0.409318, y1:0.636, x2:0.432, y2:0.0454545, stop:0 rgba(59, 123, 255, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.verticalLayout.addWidget(self.frame_dni)
        ...
        self.btn_aceptar.setMinimumSize(QSize(0, 31))
        self.btn_aceptar.setFont(font2)
        self.btn_aceptar.setAutoFillBackground(False)
        self.btn_aceptar.setStyleSheet(u"QPushButton:hover{\n"
"	background-color: rgb(255, 255, 0);\n"
"}")
    ...
    def retranslateUi(self, add_Trabajador):
        ...
        self.btn_tick.setText("")
        self.btn_untick.setText("")
        self.label.setText(QCoreApplication.translate("add_Trabajador", u"Agregar sin foto de DNI", None))
